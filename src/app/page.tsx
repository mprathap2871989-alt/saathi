  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-4 py-16 sm:py-20 text-center">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold leading-tight mb-5">
            You don&apos;t have to
            <br className="hidden sm:block" /> carry it alone.
          </h1>

          <p className="text-emerald-100 text-lg mb-9 leading-relaxed max-w-lg mx-auto">
            Share what you&apos;re going through. Find people who understand.
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/create"
              className="px-7 py-3 bg-white text-emerald-800 font-semibold rounded-full hover:bg-emerald-50 transition-colors shadow-sm"
            >
              Share Your Story
            </Link>
            ...
            <Link
              href="/community"
              className="px-7 py-3 bg-emerald-700/50 border border-emerald-500 text-white font-medium rounded-full hover:bg-emerald-700 transition-colors"
            >
              Explore Community
            </Link>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 mt-10 text-sm text-emerald-200">
            <span className="flex items-center gap-1.5">
              <Users size={14} /> Thousands supported
            </span>

            <span className="flex items-center gap-1.5">
              <Shield size={14} /> Fully anonymous
            </span>
      ...
      <section className="max-w-2xl mx-auto px-4 py-12">
        <h2 className="font-serif text-2xl font-bold text-gray-900 text-center mb-1">
          How Solacial Works
        </h2>

        <p className="text-gray-500 text-center text-sm mb-8">
          Share what you&apos;re carrying. Find understanding. Give it back.
        </p>
          ...
          {[
            {
              ...
              desc: "Write your story. You get a generated name like BraveSoul123. No one knows who you are.",
            },
            {
              step: "2",
              icon: "🤝",
              title: "Find Understanding",
              desc: "People who've been through similar experiences can respond with empathy and lived understanding.",
            },
            {
              step: "3",
              icon: "💛",
              title: "Be There for Others",
              desc: "When you're ready, help someone else feel a little less alone. Understanding goes both ways.",
            },
          ].map(({ step, icon, title, desc }) => (
            <div
              key={step}
              className="bg-white rounded-xl border border-stone-200 shadow-sm p-5 text-center"
            >
              <div className="text-3xl mb-3">{icon}</div>

              <div className="text-xs font-bold text-emerald-700 mb-1 tracking-widest">
                STEP {step}
              </div>
      ...
      <section className="bg-stone-100/70 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 text-sm mb-6">
            You don&apos;t have to explain everything before someone understands.
          </p>
            ...
            {CATEGORIES.slice(0, 9).map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-800 block group-hover:text-emerald-800 transition-colors">
                    {cat.label}
                  </span>
          ...
          <Link
            href="/community"
            className="mt-5 inline-flex items-center gap-1 text-emerald-700 text-sm font-medium hover:underline"
          >
            ...
            {[
              {
                ...
                desc: "We generate a pseudonym for you. No real names, no photos, no identifiers.",
              },
              {
                icon: "🛡️",
                title: "Moderated Community",
                desc: "Every reported post is reviewed by our team within 24 hours.",
              },
              {
                icon: "❌",
                title: "Zero Tolerance",
                desc: "Harassment, hate speech, and bullying result in immediate removal.",
              },
              {
                icon: "🤝",
                title: "Support, Not Likes",
                desc: "We use 'Helpful' not 'Like' — keeping focus on support, not popularity.",
              },
            ].map(({ icon, title, desc }) => (
              <div
                key={title}
                className="flex items-start gap-3 bg-emerald-800/50 rounded-xl p-4"
              >
      ...
      <section className="max-w-2xl mx-auto px-4 py-14 text-center">
        ...
        <Link
          href="/create"
          className="inline-block px-9 py-3.5 bg-emerald-700 text-white font-semibold rounded-full hover:bg-emerald-800 transition-colors shadow-sm"
        >
          Write Your Story
        </Link>

        <p className="text-xs text-gray-400 mt-3">
          Anonymous by default · Free forever · No algorithm
        </p>
      </section>
      ...
      <footer className="border-t border-stone-200 py-6 px-4">
        <div className="max-w-2xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-400">
          <Link
            href="/"
            className="font-bold text-emerald-800 text-lg tracking-tight"
          >
            solacial
          </Link>
