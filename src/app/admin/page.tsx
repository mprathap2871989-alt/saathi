...
import { BarChart2, Flag, BookOpen, Users, MessageCircle } from "lucide-react";
...
export const metadata: Metadata = { title: "Admin — Solacial" };
...
export default async function AdminPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      val: stats.reportCount,
      icon: <Flag size={15} />,
      accent:
        stats.reportCount > 0 ? "text-red-600" : "text-gray-400",
    },
    {
      label: "Comments",
      val: stats.commentCount,
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          {statCards.map(({ label, val, icon, accent }) => (
            ...
            >
              <div
                className={`flex items-center justify-center mb-1 ${accent}`}
              >
                {icon}
              </div>
